...
class ProductExpandedModel {
  ...
  ProductExpandedModel.fromJson(Map<String, dynamic> json) :
    product = json['product'] ? ProductModel.fromJson(json['product'] as Map<String, dynamic>) : null,
    ...
    isFavourite = json['is_favourite'] != null ? (json['is_favourite'] == true || json['is_favourite'] == 1 || json['is_favourite'] == '1' || json['is_favourite'] == 'true') : false,
